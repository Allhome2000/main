if (typeof jQuery == "undefined") {
  (function (E, A) {
    ...
    c.fn.extend({
      ...
      addClass: function (a) {
        ...
        if (a && typeof a === "string")
          for (
            var b = (a || "").split(ga), d = 0, e = this.length;
            d < e;
            d++
          ) {
            var f = this[d];
    ...
    (function () {
            ...
            if (j && j.nodeType === 1)
              for (g = 0; C[g] != null; g++) {
                if (
                  C[g] &&
                  (C[g] === true ||
                    (C[g].nodeType === 1 && l.contains(j, C[g])))
                )
                  o.push(x[g]);
              }
            else
      ...
      var n = (l.selectors = {
          ...
          filters: {
            ...
            button: function (g) {
              return (
                "button" === g.type || g.nodeName.toLowerCase() === "button"
              );
            },
            input: function (g) {
      ...
      u.querySelectorAll &&
        (function () {
          ...
          if (
            !(j.querySelectorAll && j.querySelectorAll(".TEST").length === 0)
          ) {
            l = function (m, p, q, t) {
              p = p || u;
              if (!t && !l.isXML(p))
    ...
    c.fn.extend({
      ...
      add: function (a, b) {
        var d =
            typeof a === "string" ? c(a, b || this.context) : c.makeArray(a),
        ...
        if (w) {
          ...
          try {
            ...
            if (b.ifModified) {
              ...
              c.etag[b.url] &&
                w.setRequestHeader("If-None-Match", c.etag[b.url]);
            }
